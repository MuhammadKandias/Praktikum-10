	...
	<script>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				{
					label: 'New Cases',
					// Membuat blok warna yang ada di bawah garis jadi hilang dan berubah menjadi garis
					fill: false,
					data: <?php echo json_encode($new_cases); ?>,
					backgroundColor: 'rgba(255, 99, 132, 1)',
					borderColor: 'rgba(255,99,132,1)',
					//untuk ukuran ketebalan garis
					borderWidth: 1
				},
				{
					label: 'Total Deaths',
			...
			options: {
				...
				scales: {
					...
					xAxes: [{
						gridLines: {
							//membuat supaya baris vertikal muncul atau tidak dan berwarna apa
							color: "rgba(0, 0, 0, 0)",
						}
					}]
				}
